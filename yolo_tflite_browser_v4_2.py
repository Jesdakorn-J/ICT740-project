...
from telegram_notifier_v2 import TelegramNotifier
...
@app.route("/")
def index():
    # Use cap.get directly safely converted to int for the template
    ...
    <html>
      ...
      <body>
        ...
        <div class="meta">camera input width: {cam_w}</div>
        <div class="meta">camera input height: {cam_h}</div>
        <img src="/video_feed" />
      </body>
    </html>
    """
